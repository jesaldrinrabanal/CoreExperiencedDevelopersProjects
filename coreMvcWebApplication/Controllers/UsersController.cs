...
namespace coreMvcWebApplication.Controllers
{
    ...
    {
        private readonly coreMvcWebApplicationContext _context;

        public UsersController(coreMvcWebApplicationContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.User != null ? 
                          ...
                          Problem("Entity set 'coreMvcWebApplicationContext.User'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'coreMvcWebApplicationContext.User'  is null.");
            }
            var user = await _context.User.FindAsync(id);
            if (user != null)
            {
